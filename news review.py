...
(train_data,train_labels),(test_data,test_labels)=reuters.load_data(num_words=10000)#훈련데이터에서 가장 자주 나타나는 단어 1만개만 사용하겠다
#%% +@ Index to Word
...
review.add(layers.Dense(64,activation='relu',input_shape=(10000,)))
review.add(layers.Dense(64,activation='relu'))
review.add(layers.Dense(64,activation='relu'))
review.add(layers.Dense(46,activation='softmax'))
